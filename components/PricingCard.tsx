...
import mode from '@/components/PricingCard';

interface PricingCardProps extends Pricing {
  mode:PricingMode
}

const PricingCard: FC<PricingCardProps> =({title,description,monthlyPrice,annuallyPrice,features,isMostPopular,glowPosition}) =>{
